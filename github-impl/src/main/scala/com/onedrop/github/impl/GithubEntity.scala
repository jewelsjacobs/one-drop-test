...
/**
  * This is an event sourced entity. It has a state, [[GithubState]], which
...
class GithubEntity extends PersistentEntity {
  ...
  override type Command = GithubCommand[_]
  override type Event = GithubEvent
  override type State = GithubState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: GithubState = GithubState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case GithubState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        GithubState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class GithubState(message: String, timestamp: String)
...
object GithubState {
  /**
    ...
    */
  implicit val format: Format[GithubState] = Json.format
}

/**
  * This interface defines all the events that the GithubEntity supports.
  */
sealed trait GithubEvent extends AggregateEvent[GithubEvent] {
  def aggregateTag = GithubEvent.Tag
}

object GithubEvent {
  val Tag = AggregateEventTag[GithubEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends GithubEvent
...
/**
  ...
  */
sealed trait GithubCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends GithubCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends GithubCommand[String]
...
/**
  ...
  * application loader.
  */
object GithubSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[GithubState]
  )
}
